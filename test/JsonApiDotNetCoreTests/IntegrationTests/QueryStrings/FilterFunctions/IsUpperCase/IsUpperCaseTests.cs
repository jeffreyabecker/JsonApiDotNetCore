...
using JsonApiDotNetCoreTests.IntegrationTests.QueryStrings.FilterFunctions.IsUpperCase.Extensions;
using Microsoft.Extensions.DependencyInjection;
using TestBuildingBlocks;
using Xunit;

namespace JsonApiDotNetCoreTests.IntegrationTests.QueryStrings.FilterFunctions.IsUpperCase;

public sealed class IsUpperCaseTests : IClassFixture<IntegrationTestContext<TestableStartup<QueryStringDbContext>, QueryStringDbContext>>
{
    private readonly IntegrationTestContext<TestableStartup<QueryStringDbContext>, QueryStringDbContext> _testContext;
    private readonly QueryStringFakers _fakers = new();

    public IsUpperCaseTests(IntegrationTestContext<TestableStartup<QueryStringDbContext>, QueryStringDbContext> testContext)
    {
    ...
    public async Task Can_filter_casing_in_included_resources()
    {
        ...
        blogs[1].Posts = _fakers.BlogPost.Generate(3);

...
public sealed partial class SqlTests
{
    ...
    public async Task Can_use_multiple_operations()
    {
        ...
        {
            resource.Type.Should().Be("people");
        });
        ...
        responseDocument.Results[3].Data.SingleValue.ShouldNotBeNull().With(resource =>
        {
        ...
        responseDocument.Results[5].Data.SingleValue.ShouldNotBeNull().With(resource =>
        {
            resource.Type.Should().Be("todoItems");
        });
...
WHERE t1.""Id"" = @p1");
        ...
        {
            command.Statement.Should().Be(@"INSERT INTO ""Tags"" (""Name"", ""TodoItemId"")
VALUES (@p1, @p2)
RETURNING ""Id""");
...
WHERE ""Id"" = @p2");
        ...
        {
            command.Statement.Should().Be(
                @"SELECT t1.""Id"", t1.""CreatedAt"", t1.""Description"", t1.""DurationInHours"", t1.""LastModifiedAt"", t1.""Priority"", t2.""Id"" AS t2_SplitId, t2.""Id"", t2.""Name""
FROM ""TodoItems"" AS t1
...
WHERE t1.""Id"" = @p1");
        ...
        {
            command.Statement.Should().Be(@"DELETE FROM ""People""
WHERE ""Id"" = @p1");

...
public class QueryStringParserBenchmarks
{
    ...
    public QueryStringParserBenchmarks()
    {
        ...
        var filterReader = new FilterQueryStringParameterReader(request, resourceGraph, options, new JsonApiDotNetCore.Queries.Internal.Parsing.FilterParser(resourceFactory, Enumerable.Empty<IFilterValueConverter>()));

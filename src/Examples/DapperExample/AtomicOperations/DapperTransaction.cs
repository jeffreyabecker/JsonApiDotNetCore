...
/// </summary>
internal sealed class DapperTransaction : IOperationsTransaction
{
    ...
    public DapperTransaction(DapperTransactionFactory owner, DbTransaction current, Guid transactionId)
    {

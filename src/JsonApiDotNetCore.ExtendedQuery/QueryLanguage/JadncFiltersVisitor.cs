...
public interface IJadncFiltersVisitor<Result> : IParseTreeVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by the <c>hasExpr</c>
	/// labeled alternative in <see cref="JadncFiltersParser.expr"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitHasExpr([NotNull] JadncFiltersParser.HasExprContext context);
	/// <summary>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	Result VisitIdentifierExpr([NotNull] JadncFiltersParser.IdentifierExprContext context);
	/// <summary>
